...
;getcol4x4 ; c=hor l=ver = rc=a
; ld b,high colbufh ; colh #7
; ld a,[bc) ; #7

; ld h,high colbufvlo; colvlo #4
; add a,[hl) ; #7
; inc h ; colvhi #4
; ld h,(hl) ; #7
; ld l,a ; #4
...
;setcol4x4 ; a=hor l=ver = b=val
; shr a ; /2 #4
; shr a   ; /4 #4

; ld h,high colbufvlo; collo #4
; add a,[hl) ; #7
; inc h ; colhi #4
; ld h,(hl) ; #7
; ld l,a ; #4
...
;getcol4x4v2 h=ver a=hor
; SRL h ; #8
; RR a ; #8
; SRL h ; #8
; RR a ; #8
; add a,high #tabaddr ; #7
; ld l,a ; #4
; ld a, (hl) ; #7
; ret

;setcol4x4v2 h=ver a=hor b=val
; SRL h ; #8
; RR a ; #8
; SRL h ; #8
; RR a ; #8
