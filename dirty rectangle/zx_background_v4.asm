...
BCK_TMP_BUF_POS_NEXT_LINE MACRO () ; setup hl/de for ldi/ldd copies - A=ver A'=hor
 ADD A, 8                          ; move backup of ver 8 lines down    #4
...
BB_TB_6X6 PROC ; copy from back buffer to temp buffer - L=ver E=hor

 BCK_TMP_BUF_POS_START ()
 COPY_BLOCK_0806 ()

 BCK_TMP_BUF_POS_NEXT_LINE ()
 COPY_BLOCK_0806 ()
...
TMP_SCN_BUF_POS_NEXT_LINE MACRO () ; setup hl/de for ldi/ldd copies - A=ver A'=hor
 ADD A, 8                          ; move backup of ver 8 lines down
...
TB_SN_6X6 PROC ; copy from temp buffer to screen - L=ver E=hor

 TMP_SCN_BUF_POS_START () ; L=ver E=hor
 COPY_BLOCK_0806 ()

 TMP_SCN_BUF_POS_NEXT_LINE ()
 COPY_BLOCK_0806 ()
